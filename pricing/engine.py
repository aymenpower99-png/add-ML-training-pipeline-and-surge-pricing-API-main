...
def calculate_trip_price(
    ...
    # ── 6. Résultat ───────────────────────────────────────────────
    # Commercial rounding: ceil to nearest 5 TND
    price_exact   = result.final_price
    price_rounded = math.ceil(price_exact / 5) * 5
    ...
    output = {
        ...
        "final_price":        price_rounded,
        "final_price_exact":  price_exact,
        "currency":           "TND",
